...
const styles = StyleSheet.create({
  ...
  earningsCard: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', padding: responsiveWidth(5), borderRadius: 16, backgroundColor: AppColors.onboardingButton },
  ...
  moneyCircle: { alignItems: 'center', justifyContent: 'center', width: responsiveWidth(14), height: responsiveWidth(14), borderRadius: responsiveWidth(7), backgroundColor: AppColors.themeColor },
  ...
  statIcon: { alignItems: 'center', justifyContent: 'center', width: responsiveWidth(9.5), height: responsiveWidth(9.5), borderRadius: responsiveWidth(4.75), backgroundColor: 'rgba(64,162,247,0.24)' },
  ...
  status: { color: AppColors.badgeGreen, fontSize: responsiveFontSize(1.08), marginTop: responsiveHeight(0.35) },
});
